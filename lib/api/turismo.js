...
export const apiTurismo = {
  ...
  async listarFavoritos() {
    try {
      const { data } = await clienteHttp.get("/favoritos");
      return respostaComSucesso({ data });
    } catch (erro) {
      return respostaComErro(erro);
    }
  ...
  async adicionarFavorito(pontoId) {
    try {
      const { data } = await clienteHttp.post("/favoritos", { ponto_id: pontoId });
      return respostaComSucesso({ data });
    } catch (erro) {
      return respostaComErro(erro);
    }
  ...
  async removerFavorito(pontoId) {
    try {
      await clienteHttp.delete("/favoritos", { params: { ponto_id: pontoId } });
      return { error: null };
    } catch (erro) {
      return respostaComErro(erro);
    }
  ...
  async buscarAvaliacaoDoUsuario(pontoId) {
    try {
      const { data } = await clienteHttp.get("/avaliacoes", { params: { ponto_id: pontoId } });
      return respostaComSucesso({ data });
    } catch (erro) {
  ...
  async salvarAvaliacao({ ponto_id, nota, comentario }) {
    try {
      const { data } = await clienteHttp.post("/avaliacoes", {
        ponto_id,
        nota,
        comentario,
      });
