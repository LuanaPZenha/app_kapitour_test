...
export const kapipassApi = {
  async getPassaporte() {
    try {
      const { data } = await api.get("/kapipass/me");
      return { data, error: null };
    } catch (error) {
      return wrapError(error);
    }
  ...
  async listNiveis() {
    try {
      const { data } = await api.get("/kapipass/niveis");
      return { data, error: null };
    } catch (error) {
      return wrapError(error);
    }
  ...
  async checkin(pontoTuristicoId, latitude = null, longitude = null) {
    try {
      const { data } = await api.post("/kapipass/checkin", {
  ...
  async listCheckins(usuarioId) {
    try {
      const { data } = await api.get("/kapipass/checkins", {
  ...
  async listCarimbos(usuarioId) {
    try {
      const { data } = await api.get("/kapipass/carimbos", {
        params: { usuario_id: usuarioId },
      });
      return { data, error: null };
    } catch (error) {
  ...
  async listConquistas(usuarioId) {
    try {
      const { data } = await api.get("/kapipass/conquistas", {
        params: { usuario_id: usuarioId },
      });
      return { data, error: null };
    } catch (error) {
  ...
  async listColecoes(usuarioId) {
    try {
      const { data } = await api.get("/kapipass/colecoes", {
        params: { usuario_id: usuarioId },
      });
      return { data, error: null };
    } catch (error) {
  ...
  async listMissoes(usuarioId) {
    try {
      const { data } = await api.get("/kapipass/missoes", {
        params: { usuario_id: usuarioId },
      });
      return { data, error: null };
    } catch (error) {
  ...
  async aceitarMissao(missaoId) {
    try {
      const { data } = await api.post(`/kapipass/missoes/${missaoId}/aceitar`, {});
      return { data, error: null };
    } catch (error) {
      return wrapError(error);
    }
  ...
  async listEco(usuarioId) {
    try {
      const { data } = await api.get("/kapipass/eco", {
        params: { usuario_id: usuarioId },
      });
      return { data, error: null };
    } catch (error) {
  ...
  async registrarEco(ecoAtividadeId) {
    try {
      const { data } = await api.post("/kapipass/eco/registrar", {
  ...
  async listDiario(usuarioId) {
    try {
      const { data } = await api.get("/kapipass/diario", {
        params: { usuario_id: usuarioId },
      });
      return { data, error: null };
    } catch (error) {
  ...
  async listTesouros(usuarioId) {
    try {
      const { data } = await api.get("/kapipass/tesouros", {
        params: { usuario_id: usuarioId },
      });
      return { data, error: null };
    } catch (error) {
  ...
  async concluirTesouro(tesouroId) {
    try {
      const { data } = await api.post(`/kapipass/tesouros/${tesouroId}/concluir`, {});
      return { data, error: null };
    } catch (error) {
      return wrapError(error);
    }
  ...
  async getRankings(categoria = "exploradores", page = 1, size = 20) {
    try {
      const { data } = await api.get("/kapipass/rankings", {
