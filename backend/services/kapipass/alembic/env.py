...
KAPIPASS_ROOT = Path(__file__).resolve().parents[1]
sys.path.insert(0, str(KAPIPASS_ROOT))
sys.path.insert(0, str(KAPIPASS_ROOT.parents[1] / "shared"))
...
import app.infraestrutura.persistencia.modelos  # noqa: F401, E402
