...
# Garante imports do serviço auth
AUTH_ROOT = Path(__file__).resolve().parents[1]
sys.path.insert(0, str(AUTH_ROOT))
sys.path.insert(0, str(AUTH_ROOT.parents[1] / "shared"))
...
# Importa modelos para metadata
from app.infraestrutura.persistencia.modelos import TokenOperacaoModelo, UsuarioModelo  # noqa: F401, E402
